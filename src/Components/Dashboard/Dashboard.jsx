...
export default function Dashboard() {
  ...
  const{data:TotalVehicles,isLoading:IsVehicelsLoading}=useQuery({
    queryKey: ["Vechiels"],
    queryFn: () => fetchData("https://veemanage.runasp.net/api/Dashboard/Total-Vehicle"),
  })
...
return (
  (fuelCostIsloading || maintenanceCostIsloading || IsVehicelsLoading || tripWithFaultIsloading || tripCompletedIsloading) ? (
    <Loader/>
  ) : (
    <div className="main">
      <div className="flex justify-between items-center">

      <select className="p-2 form-control mb-3 shadow-lg rounded-lg w-48 ml-auto" name="" id="" value={Month}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white text-black border border-stone-300 shadow-md  rounded-xl w-[100%]">
          ...
          <div className="flex flex-col gap-4 p-4">
            ...
            <span className="text-2xl mb-3 font-medium">{tripWithFaults + tripCompleted}
                            <span style={{ fontSize: "12px" }}> Per Month</span>
