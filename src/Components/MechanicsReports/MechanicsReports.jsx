...
export default function MechanicsReports() {
  ...
  const filteredData = data?.filter((item) => {
    const matchType = selected === "All" || item.reportType === selected;
    const notSeen = item.seen === false; // عرض اللي مش معملهم Seen فقط
    return matchType && notSeen;
  });
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <button
              ...
              className="flex items-center ju gap-3 bg-white text-black border border-black rounded-full px-4 py-1 shadow-sm hover:shadow-md transition ml-4"
            >
              {selected}
                ...
                const reportDetails = isInitial
                  ? [
                      ...
                      },
                      {
                        ...
                        value:
                          report?.expectedChangedParts?.join(", ") || "N/A",
                      },
                      {
                        title: "Expected Cost",
                  ...
                  <div
                    className={`${
                      ...
                      report?.seen
                        ...
                        : `bg-[#FFFFFF]`
                    } p-3 rounded border-l-8 flex flex-col shadow-md`}
                    key={index}
                  >
                    ...
                    {report?.seen ? (
                      ...
                      <button
                        className="mt-auto bg-blue-500 text-white py-1 px-3 rounded-md ml-auto"
                        onClick={() => {
