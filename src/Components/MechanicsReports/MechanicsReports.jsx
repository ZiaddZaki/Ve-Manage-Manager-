...
import React from "react";
  ...
  export default function MechanicsReports() {
    ...
    return <>
      ...
      <div className="bg-[#FFFFFF] p-3 rounded  border-l-8 border-yellow-500 flex flex-col">
        <div className=" text-black font-semibold mb-3 text-xl  "> Initial Report </div>
          ...
          <button className="bg-blue-500 text-white rounded-md py-2 px-3 mt-4 ml-auto hover:bg-blue-700 flex items-center gap-1"> <IoCheckmarkDone/>  Mark as Seen</button>
